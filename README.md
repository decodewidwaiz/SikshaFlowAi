...
*SikshaFlow AI* revolutionizes how educators, trainers, and content creators design lessons.  
...
| 🧠 AI Core | Google Gemini API (Text, Voice, Image generation) |
| 🧩 Backend | Flask (Python) |
| 🗂 Media Engine | MoviePy + gTTS + PyDub |
...
```bash
git clone https://github.com/yourusername/SikshaFlow AI-ai.git
cd SikshaFlow AI-ai
